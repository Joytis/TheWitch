...
/// <summary>
/// Gather Herbs buff (counter): the next potion the Witch <em>creates</em> is rolled one rarity higher.
/// One stack is consumed per upgraded creation. Honored only by the Witch's own rarity-rolling potion
...
/// </summary>
public sealed class NextPotionUpgradedPower : WitchPower
{
