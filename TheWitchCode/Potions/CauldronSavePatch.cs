...
public static class CauldronSaveState
{
    ...
    private static string FilePath =>
        Path.Combine(Godot.ProjectSettings.GlobalizePath("user://"), "thewitch_cauldron_state.json");
    ...
    public static void Write(Player player)
    {
        ...
        {
            Log.Warn($"[TheWitch] Failed to write Cauldron sidecar save: {ex.Message}");
        }
    }
    ...
    public static void Restore(Player player)
    {
        ...
        {
            Log.Warn($"[TheWitch] Failed to restore Cauldron sidecar save: {ex.Message}");
        }
    }
}
