...
/// <summary>
/// Shared Wicken sfx/vfx mechanic signatures. See Docs/sfx-vfx-catalog.md for the
/// base-game asset catalog and Docs/sfx-vfx-proposal.md for the house palette.
/// </summary>
public static class WickenFx
{
    ...
    public static readonly Color WickenGreen = new("83eb85");
    ...
    public static void SporePuff(Creature owner) => Attach(NSporeImpactVfx.Create(owner, WickenGreen));
    ...
    public static void GreenGas(Creature target) => Attach(NGaseousImpactVfx.Create(target, WickenGreen));
