...
public partial class MainFile : Node
{
    ...
    public static void Initialize()
    {
        ...
        // Shared Common/ services (source-included): run analytics via the game's official
        // OnMetricsUpload hook (+ our AnalyticsEnabled toggle) and the Workshop self-update check.
        Bird.Common.BirdModContext ctx = new()
        {
            ModId = ModId,
            LocPrefix = "THEWITCH",
            Logger = Logger,
            CharacterKey = Character.Witch.CharacterId,
            Character = () => MegaCrit.Sts2.Core.Models.ModelDb.Character<Character.Witch>(),
            AnalyticsEnabled = () => Config.WitchConfig.AnalyticsEnabled,
        };
