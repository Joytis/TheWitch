...
/// <summary>Reward/merchant-pool stub (Rare Power). Card rewards and merchant stock throw ("couldn't generate a
...
public sealed class AugurStubPowerRare : AugurCard
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new PowerVar<StrengthPower>(3m)
    ];

    public AugurStubPowerRare()
