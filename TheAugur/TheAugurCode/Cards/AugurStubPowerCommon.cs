...
/// <summary>Reward/merchant-pool stub (Common Power). Card rewards and merchant stock throw ("couldn't generate a
...
public sealed class AugurStubPowerCommon : AugurCard
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new PowerVar<StrengthPower>(1m)
    ];

    public AugurStubPowerCommon()
