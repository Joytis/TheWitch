...
/// <summary>Reward/merchant-pool stub (Common Skill). Card rewards and merchant stock throw ("couldn't generate a
...
public sealed class AugurStubSkillCommon : AugurCard
{
