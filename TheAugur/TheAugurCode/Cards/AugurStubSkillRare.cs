...
/// <summary>Reward/merchant-pool stub (Rare Skill). Card rewards and merchant stock throw ("couldn't generate a
...
public sealed class AugurStubSkillRare : AugurCard
{
